...
export const SUCCESSFUL_DIDS_LOG_INTERVAL = 100_000;
export const PDS_HEALTH_CHECK_CONCURRENCY = 50;
export const PDS_HEALTH_CHECK_TIMEOUT_MS = 25_000;
export const PDS_DATA_FETCH_CONCURRENCY = 150;
export const DIDS_TO_PROCESS = parseInt(process.argv[2], 10) || 1_000_000_000;
